...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'topshop' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'topshop' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'topshop' ),
		'cyrillic'     => __( 'Cyrillic', 'topshop' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'topshop' ),
		'devanagari'   => __( 'Devanagari', 'topshop' ),
		'greek'        => __( 'Greek', 'topshop' ),
		'greek-ext'    => __( 'Greek Extended', 'topshop' ),
		'khmer'        => __( 'Khmer', 'topshop' ),
		'latin'        => __( 'Latin', 'topshop' ),
		'latin-ext'    => __( 'Latin Extended', 'topshop' ),
		'vietnamese'   => __( 'Vietnamese', 'topshop' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'topshop' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'topshop' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'topshop' ),
